						...
						<div class="menuAdmin-insert__kind">
							<ul>
								<li><input type="radio" id="cookie-etc" name="kind"
									value="COOKIE&ETC" data-kind="cookie-etc" checked /> <label
									for="cookie-etc">COOKIE&ETC</label> <input type="radio"
									id="dessert" name="kind" value="DESSERT" data-kind="dessert" />
									<label for="dessert">DESSERT</label></li>
