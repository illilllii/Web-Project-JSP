...
<link rel="stylesheet"
	href="/ediya/assets/summernote/summernote-lite.css">
...
<script type="text/javascript"
	src="/ediya/assets/summernote/summernote-lite.js"></script>
<script type="text/javascript"
	src="/ediya/assets/summernote/summernote-ko-KR.js"></script>
<!--  
					...
					<c:when test="${sessionScope.principal != null}">
						<div class="topbar__submenu">
							...
							<a class="topbar__submenu__login" style="margin-left: 10px;"
								...
								class="topbar__submenu__login" href="" style="margin-left: 10px;">매장찾기</a>


							<c:if test="${sessionScope.principal.userRole eq 'ADMIN'}">
								<a class="topbar__submenu__admin-menu"
								href="<%=request.getContextPath()%>/admin?cmd=menuList" style="margin-left: 10px;">메뉴관리</a>
							<a class="topbar__submenu__admin-user" style="margin-left: 10px;"
								href="<%=request.getContextPath()%>/admin?cmd=userList"> 회원관리</a>
							</c:if>
			...
			<nav class="nav-menu d-none d-lg-block">
				<ul>
					...
					<li class="drop-down"><a
						href="/ediya/notice?cmd=noticeList&page=0">이디야 소식</a>
						<ul>
